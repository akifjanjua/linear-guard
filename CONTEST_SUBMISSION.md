...
I built Linear Guard as a signed RailCall module for real Linear workspaces. It provides 22 focused commands covering workspace discovery, sprint health, approval-controlled issue and label lifecycle work, attachments, issue relations, governed triage, transactional sprint planning, and bounded multi-issue sprint rebalancing.
