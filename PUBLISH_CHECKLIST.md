# Linear Guard v1.5.5 Publish Checklist
...
git commit -m "Prepare Linear Guard v1.5.5 signed-tree release"
```
...
```bash
git add module.sig
git commit -m "Sign Linear Guard v1.5.5 module tree"
```
...
```text
dist/linear-guard-v1.5.5.zip
dist/linear-guard-v1.5.5.files.json
```
