#!/usr/bin/env python3
"""Accept the committed Linear Guard release archive before publication."""
...
def main() -> int:
    ...
    files_path = ROOT / "dist" / f"linear-guard-v{version}.files.json"
    ...
    with tempfile.TemporaryDirectory(prefix="linear-guard-v152-") as temp_dir:
