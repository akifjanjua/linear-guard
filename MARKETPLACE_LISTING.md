...
It provides 23 focused commands: 11 low-risk discovery and reporting commands plus 12 approval-controlled writes. The module can discover teams, projects, labels, workflow states, members, and cycles; search and retrieve issues; view an issue's audit history; analyze sprint health; create, update, and archive issues (including sub-issue parent links); create and archive issue labels; add and update comments; attach a URL to an issue; link two issues with a typed relation; apply a complete triage decision; create a bounded sprint plan, and rebalance an existing sprint in one batch.
