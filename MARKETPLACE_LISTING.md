...
It provides 31 focused commands: 11 low-risk discovery and reporting commands plus 20 approval-controlled writes. The module can discover teams, projects, labels, workflow states, members, and cycles; search and retrieve issues; view an issue's audit history; analyze sprint health; create, update, archive, and unarchive issues (including sub-issue parent links); create, update, and archive issue labels; add, update, resolve, and unresolve comments; attach and delete issue attachments; link and unlink two issues with a typed relation; create and update cycles; apply a complete triage decision; create a bounded sprint plan, and rebalance an existing sprint in one batch.
